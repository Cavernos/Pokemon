import pygame
from app.Sprite.entity.Player import Player
from tool import Tool
from keylistener import KeyListener
from screen import Screen

class Entity(pygame.sprite.Sprite):
    def init(self, keylistener  : KeyListener, screen : Screen, x : int, y : int):
        self.screen= Screen
        self.keylistener = KeyListener
        self.spritsheet = pygame.image.load("../../src/app/assets/character/hero_01_red_m_walk.png")
        self.image= Tool.split_image(self.spritsheet, 0, 0, 24, 32)
